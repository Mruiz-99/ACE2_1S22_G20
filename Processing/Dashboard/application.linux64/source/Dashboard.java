...
public JSONArray sendGetRequest(String path){
  try{
...
public void drawCO2(int x, int y, String title, double new_ppm, double old_ppm){
...
public void drawCO2Chevron(int x, int y, double new_ppm, double old_ppm, double chevron_type){
  if(chevron_type > 0){
    lastChangeC = 1;
...
public void drawHumidity(int x, int y, String title, double new_hum, double old_hum){
...
public void drawHumidityChevron(int x, int y, double chevron_type){
  if(chevron_type > 0){
    lastChangeH = 1;
...
public void drawLight(int x, int y, String title, double new_lumen, double old_lumen){
  // Background Shape and Icon
  shape(roundedLargeSquare, x, y);
...
public void drawLightChevron(int x, int y, double chevron_type){
  if(chevron_type > 0){
    lastChangeL = 1;
...
public void drawTemp(int x, int y, String title, double new_temp, double old_temp){
  shape(roundedSquare, x, y);
  ...
  quad(
    ...
    x+67,(float)(y+192-(new_temp*1.46f)), // Right Upper
    x+60,(float)(y+192-(new_temp*1.46f))   // Left Upper
  );
...
public void drawTemp(int x, int y, String title, double new_temp, double old_temp, boolean type){
  shape(roundedSquare, x, y);
  shape(termometro, x+20,y+20);
...
public void drawTempNChevron(int x, int y, double new_temp, double old_temp, double chevron_type, boolean type){
  if(chevron_type > 0){
